...
This repository contains the package with common types for backend services.
...
In order to install and use the linked dependencies for `types` the following command can be used:
